...
public class PokerView extends BorderPane implements Initializable, Observer {
    ...
    /**
     * Enable or disable the bet's amount input field according to the argument. Give true enable
    ...
    /**
     * Enable or disable the smallBlind button according to the argument. Give true enable the
     * button and false to disable it.
     *
     * @param b the boolean value.
     */
