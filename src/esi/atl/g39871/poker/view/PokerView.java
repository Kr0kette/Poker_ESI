...
public class PokerView extends BorderPane implements Initializable, Observer {
  ...
  public void addPlayerInLayout(Player player) { // TODO refaire ccette méthode, il y a trop de
    ...
    playerView.setCurrentBet(Integer.toString(player.getCurrentBet()));//TODO c'est juste pour tester 
  ...
  public void update(Observable o, Object o1) {
    ...
    if (o1 == Status.END_MATCH) {
      updatePlayers();
      //TODO dans le modele faudrait faire en sorte que quand on est en end-match, on ne puisse pas continuer de faire fold, call etc 
