...
public class BetIterator extends PlayerIterator {
  ...
  /**
   * Iterator usefull for all the bet's state (Blind, Preflop,Flop, Turn and River). At each bet's
   * round, a new Iterator is instanciante on the precedent iterator basis. The stating index is ...
   * 
