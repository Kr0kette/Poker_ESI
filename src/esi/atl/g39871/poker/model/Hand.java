...
/**
 * The 5 cards chosen by a player at the end of the game. A hand is composed by 2 cards from the
 * PlayerCards and 3 cards from the board. The HandFactory can build a Hand : the factory send a
 * Category and a Proposal.
 *
 * @author esiProfs
 */
public class Hand implements Comparable<Hand> {
  ...
  /**
   * The HandFactory send a Category and a Proposal to build this Hand. The Hand is split in two
   * list of cards :
   * <ul>
