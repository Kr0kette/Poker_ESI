...
public class Card implements Comparable<Card> {
    ...
    /**
     * Checks if the card is the next one of an other card. It will check both
     * the card's value and the card's color
     *
     ...
     * <p>
     * For example: the card has the value 'TWO' the other card has the value
     * 'ACE'
     * <p>
     * the following call will return true: card.isNextValue(theOtherCard)
     *
     * @param other the other card
     * @return true if the card's value is just the next value from the other
     ...
     * @return true if the color in argument is the same as the card's color,
     *         false otherwise
     */
     ...
     * @return true if the value in argument is the same as the card's value,
     *         false otherwise
     */
     ...
     *
     * @param other the other card
     * @return true if the card's value is the same as the other card's value ,
     *         false otherwise
     */
