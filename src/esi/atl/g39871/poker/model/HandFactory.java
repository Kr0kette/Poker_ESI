...
/**
 * The HandFactory can build a Hand : The 5 cards chosen by a player at the end of the game. A hand
 * is composed by 2 cards from the PlayerCards and 3 cards from the board. To build the best hand,
 * this factory build some proposal first.
 *
 * @author esiProfs
 */
public class HandFactory {
  ...
  /**
   * To build the best player's hand, the factory needs the 2 cards from the players cards and the 5
   * cards from the board. The factory need to select 3 cards from the board to build the best hand.
   * There is 10 ways to chose a hand. Each way forms a proposal
   *
   *
  ...
  public HandFactory(List<Card> handCards, List<Card> board) {
    ...
    for (int indexFirstCard = 0; indexFirstCard < nb_cards - 2; indexFirstCard++) {
      for (int indexSecondCard =
          indexFirstCard + 1; indexSecondCard < nb_cards; indexSecondCard++) {
        for (int indexThirdCard =
            indexSecondCard + 1; indexThirdCard < nb_cards; indexThirdCard++) {
