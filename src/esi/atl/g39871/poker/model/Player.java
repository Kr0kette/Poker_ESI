...
public class Player {
  ...
  /**
   * A player is call by its name and owns an amount of money to play. He received two cards during
   * the preflop.
   *
   * @param name
   * @param money
  ...
  /**
   * Check if the player owns the button. The first player to bet is next to the button's owner
   *
  ...
  /**
   * Make the bet. Add the amount to the currentBet and withdraw the amount from the money
   *
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.name, other.getName()); // TODO c'est pas top top , les gens ont le
                                                       // droit d'avoir le même nom ._. si j'ai 5
                                                       // min je changerai ca en rajoutant un autre
                                                       // attribut unique
  }

  /**
   * Set the player's hand. The 2 player's cards and the 3 cards from the board
   *
   ...
   * @return -1 if the other's hand is better than this one, 0 if the two hand is equivalent and 1
   *         in the other cases
   */
  ...
  /**
   * Return the player's hand. The 2 player's cards and the 3 cards from the board
   *
