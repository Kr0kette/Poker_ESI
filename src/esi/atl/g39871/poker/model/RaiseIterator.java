...
public class RaiseIterator extends PlayerIterator {
  ...
  /**
   * Needed iterator when a plyer make a raise. When the current player raises, all other players
   * still in the pot must either call the full amount of the bet or raise if they wish remain in.
   *
