...
/**
 * Sum of money that players wager during a single hand. The pot can be split into several pot if a
 * player is all in
 *
 * @author esiProfs
 */
class Pots {
  ...
  /**
   * Sum of money that players wager during a single hand. The pot may contain some sub-pots if a
   * player is all in.
   */
  Pots() {
    pots = new ArrayList<>();
